  ...
  return (
    <div>
      <section id="section1" className='flex justify-center border-4 h-110 items-center relative overflow-hidden '>
        <h1 className='border-2 -m-12 w-72 text-2xl xl:w-98 xl:h-80 lg:ml-0 absolute font-black xl:text-4xl animate-horizontalAppearance lg:text-2xl md:text-2xl lg:h-64 lg:w-80 md:w-72 md:-ml-14 '>Pass<span className='text-green-400'>Sphere</span> is a secure online vault that stores and organizes your login credentials, providing a convenient and safe way to access your online accounts. </h1>
        
        <div className='border-2 absolute xl:w-98 -bottom-280  sm:animate-verticalAppearance animate-verticalAppearance_ph xl:ml-102 lg:w-96 sm:ml-96 -z-1   '>
          <dotlottie-player 
      ...
      <section  id='section2' className=' flex flex-wrap sm:flex-nowrap justify-center relative gap-48 border-2 bg-slate-200  '>
        <div  className={`sm:sticky border-2 z-1  border-red-400  top-48 sm:m-4 mt-8 mx-4 lg:w-100 xl:h-96 lg:h-84 lg:ml-10 md:h-96 md:ml-10  md:w-96 font-semibold flex justify-center text-justify flex-col`}>
        ...
        <div className='ClientSection flex flex-col lg:flex-row md:flex-col items-center justify-center gap-4 m-10'>
          <div className='border-2  lg:h-96 lg:w-80 md:w-80  m-6 p-4 animate-glow '>
            ...
            <div className="border-2 ">
              <img className='rounded-full border-2 h-40 w-48 block m-auto p-4' src={c1} alt="client1" />
          ...
          <div className='border-2  lg:h-96 lg:w-80 lg: md:w-80 m-6 p-4 animate-glow '>
            ...
            <div className="border-2 ">
              <img className='rounded-full border-2 h-40 w-48 block m-auto p-4' src={c2} alt="client2" />
          ...
          <div className='border-2  lg:h-96 lg:w-80 lg: md:w-80 m-6 p-4 animate-glow '>
            ...
            <div className="border-2 ">
              <img className='rounded-full border-2 h-40 w-48 block m-auto p-4' src={c3} alt="client3" />
